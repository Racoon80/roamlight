...
_SETTINGS = {
    ...
    # ⚠ All of it here and none of it in the YAML, on purpose: an installation
    #   points itself at a Keycloak or an Authentik from the settings page.
    "oidc_provider":          lambda: "",      # which preset the page picked
    "oidc_issuer":            lambda: "",
    "oidc_client_id":         lambda: "",
    "oidc_redirect_uri":      lambda: "",
    "oidc_scopes":            lambda: "openid email profile",
    "oidc_username_claim":    lambda: "preferred_username",
    "oidc_groups_claim":      lambda: "groups",
    # Only for a provider without discovery. The road is the issuer.
    "oidc_authorization_url": lambda: "",
    "oidc_token_url":         lambda: "",
    "oidc_userinfo_url":      lambda: "",
    "oidc_jwks_url":          lambda: "",
    "oidc_end_session_url":   lambda: "",
